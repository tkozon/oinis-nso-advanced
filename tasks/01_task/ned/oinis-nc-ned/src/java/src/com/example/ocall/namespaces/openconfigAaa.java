...
public class openconfigAaa extends ConfNamespace {
    public static final int hash = 422073729;
    public int hash() {
        return openconfigAaa.hash;
    }

    public static final String id = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/aaa";
    public String id() {
        return openconfigAaa.id;
    }

    public static final String uri = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/aaa";
    public String uri() {
