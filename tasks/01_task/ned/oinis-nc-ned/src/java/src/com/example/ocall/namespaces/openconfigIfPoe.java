...
public class openconfigIfPoe extends ConfNamespace {
    public static final int hash = 875613531;
    public int hash() {
        return openconfigIfPoe.hash;
    }

    public static final String id = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/poe";
    public String id() {
        return openconfigIfPoe.id;
    }

    public static final String uri = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/poe";
    public String uri() {
