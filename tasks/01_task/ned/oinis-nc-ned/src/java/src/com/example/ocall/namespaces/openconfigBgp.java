...
public class openconfigBgp extends ConfNamespace {
    public static final int hash = 1597872437;
    public int hash() {
        return openconfigBgp.hash;
    }

    public static final String id = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/bgp";
    public String id() {
        return openconfigBgp.id;
    }

    public static final String uri = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/bgp";
    public String uri() {
