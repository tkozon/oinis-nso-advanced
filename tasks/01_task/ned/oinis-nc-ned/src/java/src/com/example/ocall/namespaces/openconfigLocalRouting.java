...
public class openconfigLocalRouting extends ConfNamespace {
    public static final int hash = 1151978970;
    public int hash() {
        return openconfigLocalRouting.hash;
    }

    public static final String id = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/local-routing";
    public String id() {
        return openconfigLocalRouting.id;
    }

    public static final String uri = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/local-routing";
    public String uri() {
