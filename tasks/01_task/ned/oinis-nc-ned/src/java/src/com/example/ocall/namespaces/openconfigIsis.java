...
public class openconfigIsis extends ConfNamespace {
    public static final int hash = 1626316602;
    public int hash() {
        return openconfigIsis.hash;
    }

    public static final String id = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/openconfig-isis";
    public String id() {
        return openconfigIsis.id;
    }

    public static final String uri = "_oinis-nc-ned-nc-1.0:oinis-nc-ned-nc-1.0#http://openconfig.net/yang/openconfig-isis";
    public String uri() {
